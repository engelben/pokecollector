...
# Include routers
from api import auth, cards, collection, sets, wishlist, binders, dashboard, analytics, sync, products, trades, export, backup, settings, images, social, pokedex, public, profile, photo_imports, budget
...
app.include_router(photo_imports.router, prefix="/api/photo-imports", tags=["photo-imports"])
