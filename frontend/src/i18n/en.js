...
const en = {
  ...
  photoImport: {
    ...
    commitMode: 'Collection update mode',
    addMode: 'Add scanned quantities',
    setMode: 'Set scanned quantities',
    addModeHelp: 'Adds scanned copies to quantities already owned.',
    setModeHelp: 'Sets only the exact scanned card versions to the scanned quantity. Other collection entries are untouched.',
    startSession: 'Start photo import',
    sessionCreated: 'Photo import started',
    createFailed: 'Could not start photo import',
    capture: 'Capture',
    review: 'Review',
    summary: 'Summary',
    cardsDetected: 'cards detected',
    photos: 'photos',
    deleteSessionConfirm: 'Discard this import session and its stored photos?',
    discardSession: 'Discard session',
    photoGuidance: 'Photograph the complete binder page straight-on, with the selected grid filling the frame. Avoid strong reflections.',
    ...
    noMatch: 'No proposed match',
    manual: 'Manual',
    foilUncertain: 'Foil variant needs review',
    accept: 'Accept',
    change: 'Change',
    exclude: 'Exclude',
    changeCard: 'Change associated card',
    searchHelp: 'Search by card, species, set, abbreviation, collector number, or Pokédex number.',
    searchPlaceholder: 'Pikachu 025, MEW 025, #094…',
    likelyCandidates: 'Likely candidates',
    useSelectedCard: 'Use selected card',
    sortConfidence: 'Lowest confidence first',
    sortPhoto: 'Photo and slot order',
    applyDefaults: 'Apply defaults to unedited cards',
    noItemsForFilter: 'No cards match this review filter.',
    reviewSummary: 'Review collection update',
    acceptedCards: 'Accepted cards',
    uniqueEntries: 'Unique entries',
    scannedCopies: 'Scanned copies',
    excluded: 'Excluded',
    ...
    scanned: 'Scanned',
    result: 'Result',
    commitConfirm: 'Apply the displayed collection update? This session can only be committed once.',
    applyCollectionUpdate: 'Apply collection update',
    entriesApplied: 'collection entries processed',
    commitFailed: 'Photo import commit failed',
    analysisFailed: 'Photo analysis failed',
    filters: {
      needs_review: 'Needs review', unresolved: 'Unresolved', accepted: 'Accepted', excluded: 'Excluded', all: 'All',
    },
    reasons: {
      exact_number: 'Exact number', exact_name: 'Exact name', simplified_name: 'Name variant', partial_name: 'Partial name',
      set_match: 'Set match', language_match: 'Language match', no_candidates: 'No candidates', weak_match: 'Weak match',
      artwork_match: 'Artwork verified', manual_selection: 'Selected manually',
    },
  },
  ...
  collectorProfiles: {
    collectingAs: 'Collecting as',
    switchCollector: 'Switch collector',
    switch: 'Switch',
    switchFailed: 'Could not switch collector',
    primaryProfile: 'Primary profile',
    managedProfile: 'Managed collector profile',
    manage: 'Manage collector profiles',
    add: 'Add collector profile',
    addHelp: 'Create a separate local collection without another login account.',
    namePlaceholder: 'Collector name',
    none: 'No managed collector profiles yet.',
    created: 'Collector profile created',
    saved: 'Collector profile saved',
    deleted: 'Collector profile deleted',
    active: 'Active',
    disabled: 'Disabled',
    disable: 'Disable',
    enable: 'Enable',
    disabledMessage: 'Collector profile disabled',
    enabledMessage: 'Collector profile enabled',
    pin: 'Parent PIN',
    pinHelp: 'Optional: require this PIN when switching from this collector back to the managing profile.',
    pinPlaceholder: '4–8 digit PIN',
    pinReplacePlaceholder: 'New PIN, or leave blank to remove',
    pinProtected: 'PIN protected',
    pinSaved: 'Profile PIN saved',
    pinRemoved: 'Profile PIN removed',
    removePin: 'Remove PIN',
    enterPin: 'Enter the parent PIN to switch back.',
    deleteConfirm: 'Deleting {name} permanently removes that profile and all of its collection data. Type the profile name to confirm:',
    futureIdentity: 'A managed profile can later be linked to its own login identity while keeping the same collection data.',
  },
  ...
  wishlist: {
    ...
    affordableUnder: 'Affordable under',
    clearFilters: 'Clear filters',
    ascending: 'Ascending',
    descending: 'Descending',
    sortAscending: 'Sort ascending',
    sortDescending: 'Sort descending',
    copyCount: '{count} requested copies',
    requestedCopies: '{count} requested',
  ...
  settings: {
    ...
    colorModeDesc: 'Choose the base brightness for the application.',
    ...
    accent: 'Accent',
    accentDesc: 'Choose the color used for identity and interactive emphasis.',
    accentDefault: 'Pokédex Red',
    accentFire: 'Fire',
    accentWater: 'Water',
    accentGrass: 'Grass',
    accentElectric: 'Electric',
    accentPsychic: 'Psychic',
    accentDragon: 'Dragon',
    accentDark: 'Dark type',
    accentFairy: 'Fairy',
    selected: 'Selected',
